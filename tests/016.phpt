...
Warning: UnQLite\Doc::fetch_id(): expects parameter 1 to be an numeric: a in %s on line %d
NULL
=== fetch id ===
ID: NULL
RESULT:

Warning: UnQLite\Doc::fetch_id(): expects parameter 1 to be an numeric:  in %s on line %d
NULL
